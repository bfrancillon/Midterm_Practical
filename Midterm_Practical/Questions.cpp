...
{
	QuestionNumber2 = "\nWhich one of these character is not a friend of Harry Potter?\n ";
...
{
	QuestionNumber3 = "\nWhich animal does not appear on the Chinese zodiac? \n";
...
{
	QuestionNumber5 = "\nIn the Pirates of the Caribbean, what was Captain Jack Sparrow's Ship's name? \n";
